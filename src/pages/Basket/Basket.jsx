...
const Basket = () => {
    ...
    const {basket, plusItem, minusItem, delBasket} = useContext(CustomContext);
        ...
        <section className='basket'>
            <div className="container">
                ...
                <div className='basket__row'>
                    <h2 className='basket__title productFilter__title'>Cart</h2>
                    <p className='basket__count'>(there are {basket.length} items in the cart)</p>
                </div>
                            ...
                            <li key={item.id} className="basket__item">
                                ...
                                <div className="basket__item-right">
                                    <div className='basket__item-count'>
                                        <button className='basket__btn' type='button'   onClick={()=>minusItem(item.id)}>
                                        ...
                                        <button className='basket__btn' type='button'   onClick={()=> plusItem(item.id)}>
